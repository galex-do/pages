...
Как итог, стек PLG удобен на небольших и средних проектах. Loki умеет экспортировать логи в объектное хранилище для длительного хранения, что позволяет сэкономить на хранении данных, особенно при использовании облачных платформ.
...
* Разобрались с концепцией централизованного логирования и зачем оно нужно
...
* Познакомились с популярными решениями и инструментами централизованного логирования
