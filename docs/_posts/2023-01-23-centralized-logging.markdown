...
Копая логи на серверах по отдельности, можно найти много интересного. Но есть пара аспектов, которые становятся критичными при масштабировании парка серверов:
