...
* На больших объемах данных скорость выполнения запросов в Loki, как правило, проигрывает Elasticsearch (**-**)
...
В PLG-стеке мы размещаем на серверах агент Promtail, который собирает логи на месте, парсит их, фильтрует и пересылает в Loki.
